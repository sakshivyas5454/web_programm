...
<tr><td>Country: </td><td><select id="Country" name="Country">
		 ...
		 <option>Rusia</option></select></td></tr>
...
<tr><td>Language:</td><td> <label><input type="checkbox" name="English" value="English" id="english" checked>English
          <input type="checkbox" name="Non English" value="Non English" id="non english">Non English</td></tr></label>
